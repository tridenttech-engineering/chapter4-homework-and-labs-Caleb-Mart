...
// variables
  ...
  double store1Percent = 283.02;
  double store2Percent = 246.19;
  double totalPercent = 529.21;
...
cout << "total sales: " << totalPercent << endl;
cout << "store 1 sales: " << store1Percent << endl;
cout << "store 2 sales: " << store2Percent << endl;
